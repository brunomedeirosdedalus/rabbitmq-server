...
get_all_for_destination(Resource) ->
    rabbit_db:run(
      #{mnesia => fun() -> get_all_for_destination_in_mnesia(Resource) end,
        khepri => fun() -> get_all_for_destination_in_khepri(Resource) end
       }).

get_all_for_destination_in_mnesia(Resource) ->
...
get_all(SrcName, DstName) ->
    rabbit_db:run(
      #{mnesia => fun() -> get_all_in_mnesia(SrcName, DstName) end,
        khepri => fun() -> get_all_in_khepri(SrcName, DstName) end
       }).

get_all_in_mnesia(SrcName, DstName) ->
...
get_all_explicit() ->
    rabbit_db:run(
      #{mnesia => fun() -> get_all_explicit_in_mnesia() end,
        khepri => fun() -> get_all_explicit_in_khepri() end
       }).
