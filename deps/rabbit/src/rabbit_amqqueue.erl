...
-export([exists/1, lookup/1, lookup/2,
...
on_node_up(Node) ->
    %% This is going to be removed anyway with HA queues
...
filter_transient_queues_to_delete(Node, Queues) ->
    partition_queues(
      lists:foldl(
        fun(Q, Acc) ->
                case amqqueue:qnode(Q) == Node andalso
